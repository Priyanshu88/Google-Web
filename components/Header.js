        ...
        <header className="sticky top-0 bg-white">
            <div className="flex w-full p-6 items-center">
                ...
                <form className="flex flex-grow px-6 py-3 ml-10 mr-5 border border-gray-200 rounded-full shadow-lg max-w-3xl items-center">
                    <input className="flex-grow w-full focus:outline-none" ref={searchInputRef} type="text" defaultValue={router.query.term} />
                ...
                <Avatar className="ml-auto" url='https://th.bing.com/th/id/OIP.Bjh8-mPfJNbsLs6YOATRdQHaHa?pid=ImgDet&rs=1'/>
            </div>
